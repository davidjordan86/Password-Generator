...
def get_base_phrase():
    base_phrase = input("Pick a word or phrase that your password will be based on \
...
def main():
    ...
    while len(website) < 3 or not website.isalpha():
        website = get_website_name()
    ...
    password = letters + "!" + phrase.lower() + str(len(website))
